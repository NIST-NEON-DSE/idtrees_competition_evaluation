...
def parse_args(args):
    ...
    group.add_argument('--snapshot',          help='Resume training from a snapshot.', type=str)#, default = './snapshots/latest_snapshot.h5')
    group.add_argument('--imagenet-weights',  help='Initialize the model with pretrained imagenet weights. This is the default behaviour.', action='store_const', const=True, default=True)
    group.add_argument('--weights',           help='Initialize the model with weights from a file.')
    group.add_argument('--no-weights',        help='Don\'t initialize the model with any weights.', dest='imagenet_weights', action='store_const', const=False)
    #csv_parser = subparsers.add_parser('csv')./keras_retinanet/annotations/train_annotations.csv')
    parser.add_argument('--dataset_type', help='how are you reading the labels? default is csv', default='csv', type=str)
    parser.add_argument('--classes', help='Path to a CSV file containing class label mapping.', default='./annotations/species_id.csv', type=str)
    parser.add_argument('--annotations', help='Path to CSV file containing annotations for validation (optional).', default='./annotations/train_annotation.csv', type=str)    
    parser.add_argument('--val-annotations', help='Path to CSV file containing annotations for validation (optional).', type=str, default='./annotations/test_annotation.csv')
    #group = parser.add_mutually_exclusive_group()
